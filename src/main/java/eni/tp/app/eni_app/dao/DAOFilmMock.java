...
public class DAOFilmMock implements IDAOFilm {
    ...
    List<Film> films = Arrays.asList(
            new Film(1, "Les Visiteurs", 1993, 105, "En l'an de grace 1123, le comte de Montmirail et son fidèle écuyer, Jacquouille la Fripouille, se retrouvent propulsés en l'an 1992 apres avoir bu une potion magique fabriquée par l'enchanteur Eusaebius, censée leur permettre de se défaire d'un terrible sort."),
            new Film(2, "Le père Noël est une ordure", 1982, 88, "La permanence téléphonique parisienne SOS détresse-amitié est perturbée le soir de Noël par l'arrivée de personnages marginaux farfelus qui provoquent des catastrophes en chaîne."),
